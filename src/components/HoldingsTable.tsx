...
export function HoldingsTable() {
    ...
    return (
        <div className="bg-white rounded-3xl p-6 shadow-xl border border-indigo-50 overflow-x-auto">
            ...
            {/* Header for Desktop */}
            <div className="min-w-[800px] grid grid-cols-12 text-xs font-bold text-slate-400 uppercase tracking-wider px-4 mb-2 gap-4">
